...
namespace PayrollSystem {
    ...
    public partial class GrifindoToysDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(int EmployeeID, string Emp_name, System.DateTime Emp_dob, string Emp_gender, string Emp_phone, string Emp_address) {
            ...
            private void InitClass() {
                ...
                this.columnEmp_gender.MaxLength = 6;
...
namespace PayrollSystem.GrifindoToysDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Emp_name] = @Original_Emp_name) AND ([Emp_dob] = @Original_Emp_dob) AND ([Emp_gender] = @Original_Emp_gender) AND ([Emp_phone] = @Original_Emp_phone) AND ([Emp_address] = @Original_Emp_address))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([EmployeeID], [Emp_name], [Emp_dob], [Emp_gender], [Emp_phone], [Emp_address]) VALUES (@EmployeeID, @Emp_name, @Emp_dob, @Emp_gender, @Emp_phone, @Emp_address);
SELECT EmployeeID, Emp_name, Emp_dob, Emp_gender, Emp_phone, Emp_address FROM Employee WHERE (EmployeeID = @EmployeeID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EmployeeID] = @EmployeeID, [Emp_name] = @Emp_name, [Emp_dob] = @Emp_dob, [Emp_gender] = @Emp_gender, [Emp_phone] = @Emp_phone, [Emp_address] = @Emp_address WHERE (([EmployeeID] = @Original_EmployeeID) AND ([Emp_name] = @Original_Emp_name) AND ([Emp_dob] = @Original_Emp_dob) AND ([Emp_gender] = @Original_Emp_gender) AND ([Emp_phone] = @Original_Emp_phone) AND ([Emp_address] = @Original_Emp_address));
SELECT EmployeeID, Emp_name, Emp_dob, Emp_gender, Emp_phone, Emp_address FROM Employee WHERE (EmployeeID = @EmployeeID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Emp_name, Emp_dob, Emp_gender, Emp_phone, Emp_address FROM dbo" +
                ".Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_EmployeeID, string Original_Emp_name, System.DateTime Original_Emp_dob, string Original_Emp_gender, string Original_Emp_phone, string Original_Emp_address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int EmployeeID, string Emp_name, System.DateTime Emp_dob, string Emp_gender, string Emp_phone, string Emp_address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int EmployeeID, string Emp_name, System.DateTime Emp_dob, string Emp_gender, string Emp_phone, string Emp_address, int Original_EmployeeID, string Original_Emp_name, System.DateTime Original_Emp_dob, string Original_Emp_gender, string Original_Emp_phone, string Original_Emp_address) {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(Original_Emp_dob));
            if ((Original_Emp_gender == null)) {
                throw new global::System.ArgumentNullException("Original_Emp_gender");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Emp_gender));
            }
            if ((Original_Emp_phone == null)) {
                throw new global::System.ArgumentNullException("Original_Emp_phone");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Emp_phone));
            }
            if ((Original_Emp_address == null)) {
                throw new global::System.ArgumentNullException("Original_Emp_address");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Emp_name, System.DateTime Emp_dob, string Emp_gender, string Emp_phone, string Emp_address, int Original_EmployeeID, string Original_Emp_name, System.DateTime Original_Emp_dob, string Original_Emp_gender, string Original_Emp_phone, string Original_Emp_address) {
            return this.Update(Original_EmployeeID, Emp_name, Emp_dob, Emp_gender, Emp_phone, Emp_address, Original_EmployeeID, Original_Emp_name, Original_Emp_dob, Original_Emp_gender, Original_Emp_phone, Original_Emp_address);
        }
    }
